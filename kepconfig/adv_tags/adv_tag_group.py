...
def _get_url(base_url, adv_tag_group_path=None, *, isItem=False):
    '''Creates url object for the "adv_tag_group_path" of Kepware's project tree. Used 
    to build a part of Kepware Configuration API URL structure
    
    Returns the advanced tag group specific url when a value is passed as the tag group name.
    '''
    path_obj = adv_tags.adv_tag_path_split(adv_tag_group_path)
    try:
        url = base_url + adv_tags.ADV_TAGS_ROOT
...
def add_tag_group(server: server, adv_tag_group_path: str, DATA: Union[dict, list]) -> Union[bool, list]:
    ...
    :param adv_tag_group_path: path identifying tag group to add the tag group object(s)
    ...
    url = _get_url(server.url, adv_tag_group_path)
...
def del_tag_group(server: server, adv_tag_group_path: str) -> bool:
    ...
    :param server: instance of the `server` class
    :param adv_tag_group_path: path identifying tag group to delete
    ...
    url = _get_url(server.url, adv_tag_group_path, isItem=True)
...
def modify_tag_group(server: server, adv_tag_group_path: str, DATA: dict, force: bool = False) -> bool:
    ...
    :param server: instance of the `server` class
    :param adv_tag_group_path: path identifying the advanced tag group to modify
...
def get_tag_group(server: server, adv_tag_group_path: str) -> dict:
    ...
    :param server: instance of the `server` class
    :param adv_tag_group_path: path identifying the advanced tag group to retrieve
...
def get_all_tag_groups(server: server, adv_tag_group_path: str, *, options: dict = None) -> list:
    ...
    :param server: instance of the `server` class
    :param adv_tag_group_path: path identifying the advanced tag group collection to retrieve
